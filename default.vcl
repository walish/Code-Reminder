...
import std;
backend default {
.host = "lcm-website-qa.prism-test.co.uk";
.port = "8080";
...
if (req.url ~ "^(/media/|/skin/|/js/|/)(?:(?:index|litespeed)\.php/)?(?:admin|api|cron\.php|checkout/|admin/|customer/account/|adyen/process/redirect/|ajax/|slider/|megamenu/)" ||
